...
//            }
    ...
    public int expandHeYue(Map map) {
       ...
       int admin_id = (int)heyue.getMember().getInvite_id();
        ...
        double rate = HeYueCaculateImpl.cal_interest_rate(heyue.getHeyue_id(), heyue.getLeverage_id(),admin_id);
    ...
    @Override
    public List<com.stock.models.MemberHeYueApply> getValidHeYue() {
        return memberHeYueApplyMapper.getValidHeYue();
    }
