...
public class HeYueCaculateImpl implements HeYueCaculateService {
    ...
    @Override
    public double cal_interest_rate(int heyue_id, int leverage_id,int admin_id) {

        HashMap map = (HashMap) InterestImpl.findInterestByIds(heyue_id,leverage_id,admin_id);
