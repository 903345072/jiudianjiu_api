...
public class MemberServiceImpl implements MemberService {
    ...
    public void  renewHeYue(Integer member_heyue_id,Integer flag) {
        ...
        double rate = HeYueCaculateImpl.cal_interest_rate(heyue.getHeyue_id(),heyue.getLeverage_id(),(int)heyue.getMember().getInvite_id());
...
//        }
    ...
    @Override
    public List findCollections(Map<String, Object> map) {
        return memberHeYueApplyMapper.findCollections(map);
    }
